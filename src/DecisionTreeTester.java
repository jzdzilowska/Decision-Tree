...
public class DecisionTreeTester<G extends ITreeGenerator<D>, D extends IDataset> {
    ...
    /**
     * Calculates the average accuracy of the decision tree on the songs, villains, and mushrooms dataset
     * @param args
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            Dataset trainingData1 = makeDataset(SONG_TRAINING, Dataset.class);
            double accuracy1 =
                    tester.getDecisionTreeAccuracy(trainingData1, trainingData1, IS_POPULAR);
            System.out.println("Accuracy on songs training data: " + accuracy1);

            int numIters1 = 100;
            Dataset testingData1 = makeDataset(SONG_TESTING, Dataset.class);
            accuracy1 = tester.getAverageDecisionTreeAccuracy(trainingData1, testingData1, IS_POPULAR, numIters1);
            System.out.println("Accuracy on songs testing data: " + accuracy1);

            // villains
            Dataset trainingData2 = makeDataset(VILLAINS_TRAINING, Dataset.class);
            double accuracy2 =
                    tester.getDecisionTreeAccuracy(trainingData2, trainingData2, IS_VILLAIN);
            System.out.println("Accuracy on villains training data: " + accuracy2);

            int numIters2 = 100;
            Dataset testingData2 = makeDataset(VILLAINS_TESTING, Dataset.class);
            accuracy2 = tester.getAverageDecisionTreeAccuracy(trainingData2, testingData2, IS_VILLAIN, numIters2);
            System.out.println("Accuracy on villains testing data: " + accuracy2);

            //mushrooms
            Dataset trainingData3 = makeDataset(MUSHROOMS_TRAINING, Dataset.class);
            double accuracy3 =
                    tester.getDecisionTreeAccuracy(trainingData3, trainingData3, IS_POISONOUS);
            System.out.println("Accuracy on songs training data: " + accuracy3);

            int numIters3 = 100;
            Dataset testingData3 = makeDataset(MUSHROOMS_TESTING, Dataset.class);
            accuracy3 = tester.getAverageDecisionTreeAccuracy(trainingData3, testingData3, IS_POISONOUS, numIters3);
            System.out.println("Accuracy on songs testing data: " + accuracy3);
